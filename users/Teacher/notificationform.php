...
<div class="updates-form-container">
      ...
      <form action="updatesformdata.php" method="post" enctype="multipart/form-data">
            ...
            ?> 
              ...
              <option selected disabled>Select Years</option>
                                ...
                                <div class="input_field">
                                    ...
                                    <input class="form-control" type="file" name="documentname[]"  id="document" multiple="multiple">
        ...
        <input class="btn btn-success mb-3" type="submit"  class="btn btn-success"  value="Update">
            </div>
