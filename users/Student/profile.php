...
<body>
  ...
  <div class="home">
        ...
        <div class="action">
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><img src="images/user.png" alt=""><a onMouseOver="this.style.cursor='pointer'" onclick="location.reload();">My Profile</a></li>
    ...
    <div class="profile-row">
        ...
        <div class="profile-row-right">
            <?php echo $_SESSION['user']['semester'];?>
        </div>
    </div>
    <div class="profile-row">
        <div class="profile-row-left">
        ...
        <div class="profile-row-right">
            <?php echo $_SESSION['user']['section'];?>
        </div>
    </div>
    <div class="profile-row">
        <div class="profile-row-left">
