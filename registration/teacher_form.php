                        ...
                        <div class="form">
                            <div id="Student_details">
                                ...
                                <div class="input_field terms">
                                    ...
                                    <label class="check">
                                        BCA&nbsp;
                                        <input type="checkbox" name="bca" value="0" id="bca" onclick="changeVal(id);">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="check">
                                        BBA&nbsp;
                                        <input type="checkbox" name="bba" value="0" id="bba" onclick="changeVal(id);">
                                        <span class="checkmark"></span>
                                    </label>
                                    <label class="check">
                                        MCA&nbsp;
                                        <input type="checkbox" name="mca" value="0" id="mca" onclick="changeVal(id);">
                                        <span class="checkmark"></span>
                                    </label><label class="check">
                                        MSC&nbsp;
                                        <input type="checkbox" name="msc" value="0" id="msc" onclick="changeVal(id);">
                                        <span class="checkmark"></span>
                                    </label> 
